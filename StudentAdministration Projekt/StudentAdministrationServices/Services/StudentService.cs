...
public class StudentService : IStudentService
{
    ...
    /// <param name="degreeProgramService"></param>
    /// <param name="universityService"></param>
    public StudentService(IStudentRepository studentRepository, IDegreeProgramService degreeProgramService, IUniversityService universityService, IGradeService gradeService)
    {
...
/// </returns>
/// <remarks>
/// This method interacts with the underlying repository to remove the student
/// associated with the specified <paramref name="id"/>.
/// </remarks>
    public async Task DeleteAsync(Guid id)
    {
        await this.studentRepository.DeleteAsync(id).ConfigureAwait(false);
    }
    ...
    {
        List<Student> studentEntities = await this.studentRepository.GetAllAsync();
    ...
    {
        Student student = await this.studentRepository.GetByIdAsync(id);
    ...
    {
        List<Student> students = await this.studentRepository.GetAllAsync();
        ObservableCollection<StudentListModel> studentListModels = [];
        foreach (StudentListModel listModel in students.Select(student => ConvertToListModel(student)))
        {
    ...
    /// <param name="student"></param>
    /// <returns></returns>
    private static StudentListModel ConvertToListModel(Student student)
    {
